...
class ReparacionPagintation {
  ...
  factory ReparacionPagintation.fromRawJson(String str) =>
      ReparacionPagintation.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ReparacionPagintation.fromJson(Map<String, dynamic> json) =>
      ReparacionPagintation(
        reparaciones: json["docs"] == null
            ? []
            : List<ReparacionResponse>.from(
                json["docs"]!.map((x) => ReparacionResponse.fromJson(x))),
...
class ReparacionResponse {
  ...
  factory ReparacionResponse.fromRawJson(String str) =>
      ReparacionResponse.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ReparacionResponse.fromJson(Map<String, dynamic> json) =>
      ReparacionResponse(
        id: json["_id"],
        fecEntrada: json["fecEntrada"] == null
            ? null
            : DateTime.parse(json["fecEntrada"]),
        combustible: json["combustible"],
        kilometros: json["kilometros"],
        seguro: json["seguro"],
        chasis: json["chasis"],
        trabajos: json["trabajos"] == null
            ? []
            : List<Trabajo>.from(
                json["trabajos"]!.map((x) => Trabajo.fromJson(x))),
        danyos: json["danyos"] == null
            ? []
            : List<Danyo>.from(json["danyos"]!.map((x) => Danyo.fromJson(x))),
        taller: json["taller"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "trabajos": trabajos == null
            ? []
            : List<dynamic>.from(trabajos!.map((x) => x.toJson())),
        "danyos": danyos == null
            ? []
            : List<dynamic>.from(danyos!.map((x) => x.toJson())),
        "taller": taller,
